---
title: DELETE
description: Delete rows with the Deleter builder.
---
...
<Callout type="info">
If your struct implements `RowScanner`, prefer using `All()` on a selector or `RowScanner` over `ScanWith`. See [RowScanner](/docs/select#rowscanner-interface).
</Callout>
